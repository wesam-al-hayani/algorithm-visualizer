...
public record AlgorithmStep(
    ...
    public static AlgorithmStep text(String message, String details, Map<String, Number> statistics) {
        return new AlgorithmStep(message, "", -1, VisualKind.TEXT, List.of(), List.of(), Set.of(),
                Set.of(), Set.of(), List.of(), statistics, details);
    }

    public enum VisualKind { ARRAY, TEXT, GRAPH, TABLE, TREE, GRID, SETS }
